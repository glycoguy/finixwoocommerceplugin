...
final class Finix_Blocks_Integration extends AbstractPaymentMethodType {
    ...
    public function get_payment_method_script_handles() {
        ...
        $finix_js_url = 'https://js.finix.com/v/1/3/2/finix.js';

        // Log for debugging
        error_log('Finix: Loading Finix.js from: ' . $finix_js_url);
        error_log('Finix: Application ID: ' . substr($application_id, 0, 10) . '...');
    ...
    public function get_payment_method_data() {
        ...
        return array(
            ...
            'application' => $this->gateway->get_application_id(),
