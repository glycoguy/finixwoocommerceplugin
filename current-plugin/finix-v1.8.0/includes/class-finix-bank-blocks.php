<?php
/**
 * Finix Bank Gateway - WooCommerce Blocks Integration
 * Version: 1.8.0
 */
...
final class Finix_Bank_Blocks_Integration extends AbstractPaymentMethodType {
     ...
     * Payment method name
     */
    protected $name = 'finix_bank_gateway';

    /**
     * Initialize the payment method
     */
    public function initialize() {
        $this->settings = get_option('woocommerce_finix_bank_gateway_settings', []);
        $gateways = WC()->payment_gateways->payment_gateways();
        $this->gateway = isset($gateways['finix_bank_gateway']) ? $gateways['finix_bank_gateway'] : null;
    }
    ...
    public function get_payment_method_script_handles() {
        ...
        $script_url = FINIX_WC_SUBS_PLUGIN_URL . 'assets/js/finix-bank-blocks.js';
        $script_asset_path = FINIX_WC_SUBS_PLUGIN_DIR . 'assets/js/finix-bank-blocks.asset.php';
        ...
        wp_register_script(
            'finix-bank-blocks',
            $script_url,
            array_merge($script_asset['dependencies'], ['finix-js-bank']),
        ...
        if (function_exists('wp_set_script_translations')) {
            wp_set_script_translations('finix-bank-blocks', 'finix-wc-subs');
        }

        return ['finix-js-bank', 'finix-bank-blocks'];
    }
    ...
    public function get_payment_method_data() {
        ...
        return [
            'title' => $this->gateway ? $this->gateway->get_option('title') : __('Bank Account (EFT)', 'finix-wc-subs'),
            'description' => $this->gateway ? $this->gateway->get_option('description') : '',
            'supports' => $this->get_supported_features(),
            'gateway_id' => 'finix_bank_gateway',
            ...
            'text' => [
                ...
                'account_number' => __('Account Number', 'finix-wc-subs'),
                'routing_number' => __('Routing Number', 'finix-wc-subs'),
                'account_type' => __('Account Type', 'finix-wc-subs'),
