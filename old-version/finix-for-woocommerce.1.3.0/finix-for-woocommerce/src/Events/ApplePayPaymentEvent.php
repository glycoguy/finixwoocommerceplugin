...
/**
 * ApplePayPaymentEvent processes the actual payment via Finix and Apple Pay.
 * It's triggered on the checkout page before the order is created.
 */
class ApplePayPaymentEvent extends Event {
	 ...
	 */
	public function set_billing( array $billing ): ApplePayPaymentEvent {
	 ...
	 * Set the billing data used to create a Finix Buyer.
	 */
	public function set_token( string $token ): ApplePayPaymentEvent {
	 ...
	 * Set the billing data used to create a Finix Buyer.
	 */
	public function set_merchant( string $identity ): ApplePayPaymentEvent {
	 ...
	 */
	public function set_order( $order_id, $order_key ): ApplePayPaymentEvent {
